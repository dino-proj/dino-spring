...
for proj in "dino-dependencies-root" "dino-spring-assembly" "dino-spring-boot-starter" "dino-spring-cloud-starter" "dino-spring-commons" "dino-spring-data" "dino-spring-core"
  do
