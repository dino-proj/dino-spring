...
@Description(value = "${name} is used to decode the base64 string to plain string", usage = "${name}([charset]), the charset is optional, 'UTF-8' as default.")
public class FNBase64Decode extends Base {
